...
#for finding number of sites for each pollutant/environment
#species=metadata['AURN Pollutants Measured']
#df=metadata.loc[metadata['Environment Type']=='Background Suburban']
#df.loc[df['AURN Pollutants Measured'].str.contains('Nitrogen dioxide')]
