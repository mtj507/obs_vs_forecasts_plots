...
for environment in environments:
    ...
    for i in emissions:
        ...
        for h in np.arange(0,120,24):
            ...
            forecast_day=forecast_day.astype(str)
            plt.plot(range(24),np.median(mod_data,axis=(1,2)),label='Model Day '+ forecast_day)
